...
def parse_args():
    ...
    parser.add_argument("--center_click", default=False, action="store_true")
    parser.add_argument("--random_click", default=False, action="store_true")

    parser.add_argument("--click_noise", default=False, action="store_true")
    parser.add_argument("--noise_level", type=int, default=1)
    parser.add_argument("--noise_probability", type=float, default=0.25)

    parser.add_argument("--systematic_error", default=False, action="store_true")
    parser.add_argument("--systematic_error_probability", type=float, default=0.25)
    parser.add_argument("--uncertainty_based", default=False, action="store_true")
    parser.add_argument("--intensity_based", default=False, action="store_true")
